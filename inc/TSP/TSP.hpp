...
class TSP_Solver {
    ...
    void make_hamilton();
    void three_opt(int path[], int cnt, int max_iter, float term_cond, bool show_debug_info, int *iter_cnt);
 ...
 public:
    ...
    void solve(int max_iter = -1, float term_cond = 1e-2f, bool show_debug_info = false, int *iter_cnt = nullptr);
